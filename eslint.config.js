...
export default tseslint.config(
  ...
  // `domain/` is pure: the plan, the working calendar, placement, readiness rule by rule,
  // the figures that carry their rows. It performs no I/O and knows nothing about the UI or the host.
  ...
  //
  // Enforced twice on purpose — here, and by src/domain/boundary.test.ts.
  {
