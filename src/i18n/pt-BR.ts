...
export const ptBR: Dictionary = {
  ...
  'plan.checklist.note':
    'A caixa é marcada pelo diário — pelo que foi escrito na obra, nunca clicada aqui.',
  ...
  'errors.diaryFutureDay':
    'Uma entrada não pode ter data depois de hoje: o diário registra o que já aconteceu.',
  'errors.diaryCorrectsUnknown': 'Essa correção cita uma entrada que não existe.',
  'errors.photoRefused': 'Uma foto foi recusada, então nada foi salvo: {detail}',
  'diary.lead':
    'O que de fato aconteceu, dia a dia. Uma entrada nunca é editada: um erro é consertado por uma correção, e as duas ficam.',
  'diary.form.title': 'Na obra',
  'diary.form.day': 'Dia',
  'diary.form.worked': 'Trabalhado',
  'diary.form.finished': 'Terminado',
  'diary.form.workedOn': '{name}: trabalhado',
  'diary.form.finishedOn': '{name}: terminado',
  'diary.form.quantityOf': 'Quanto de {name}, em {unit}',
  'diary.form.running': 'O que está em andamento neste dia, ou já começou',
  'diary.form.none': 'Nada está previsto para estar em andamento neste dia.',
  'diary.form.showAll': 'Mostrar todas as atividades',
  'diary.form.showRunning': 'Mostrar só o que está em andamento',
  'diary.form.present': 'Na obra',
  'diary.form.noPeople': 'Adicione pessoas no plano para marcar quem esteve aqui.',
  'diary.form.weather': 'Tempo',
  'diary.weather.sun': 'Sol',
  'diary.weather.cloud': 'Nublado',
  'diary.weather.rain': 'Chuva',
  'diary.weather.storm': 'Tempestade',
  'diary.weather.wind': 'Vento',
  'diary.weather.somethingElse': 'Outro',
  'diary.form.more': 'Mais…',
  'diary.form.less': 'Menos campos',
  'diary.form.note': 'Nota',
  'diary.form.hours': 'Horas trabalhadas',
  'diary.form.lostDay': 'Não foi possível trabalhar (um dia perdido)',
  'diary.form.deliveries': 'Entregas',
  'diary.form.incidents': 'Ocorrências',
  'diary.form.visitors': 'Visitas',
  'diary.photos.title': 'Fotos',
  'diary.photos.choose': 'Adicionar fotos…',
  'diary.photos.path': 'Caminho de uma foto',
  ...
  'diary.save.entry': 'Salvar a entrada',
  'diary.save.correction': 'Salvar a correção',
  'diary.saved': 'Entrada nº {seq} salva.',
  'diary.problem.title': 'A entrada não foi salva',
  'diary.problem.invalidDay': 'O dia não é um dia do calendário.',
  'diary.problem.futureDay':
    'Esse dia ainda não aconteceu. Uma entrada registra o que já aconteceu.',
  'diary.problem.unknownActivity': 'Uma atividade da entrada não está mais no plano.',
  'diary.problem.unknownPerson': 'Uma pessoa da entrada não está mais no plano.',
  'diary.problem.correctsUnknown': 'A entrada que isto corrige não está no diário.',
  'diary.problem.correctionNote':
    'Diga o que estava errado — uma correção sem motivo seria uma edição.',
  'diary.problem.negativeQuantity': 'Uma quantidade é 0 ou mais.',
  ...
  'diary.correction.note': 'O que estava errado',
  'diary.correction.explain':
    'Uma entrada nunca é editada. A correção reafirma o dia inteiro; a original fica, riscada, e diz qual entrada a corrigiu.',
  'diary.days.title': 'Dia a dia',
  'diary.empty.title': 'Nada escrito ainda',
  'diary.empty.description':
    'A primeira entrada pode ser um toque: o que foi trabalhado, quem esteve aqui e o tempo.',
  'diary.entry.header': 'nº {seq} · {author} · {time}',
  'diary.entry.correction': 'Correção da nº {seq}',
  'diary.entry.correctedBy': 'Corrigida pela nº {seq}',
  'diary.entry.worked': '{name} — trabalhado',
  'diary.entry.finished': '{name} — terminado',
  'diary.entry.present': 'Na obra: {names}',
  'diary.entry.weather': 'Tempo: {weather}',
  'diary.entry.lostDay': 'Um dia perdido — não foi possível trabalhar.',
  'diary.entry.hours': 'Horas trabalhadas: {hours}',
  'diary.entry.deliveries': 'Entregas: {text}',
  'diary.entry.incidents': 'Ocorrências: {text}',
  'diary.entry.visitors': 'Visitas: {text}',
  'diary.entry.unknownActivity': 'uma atividade que não está mais no plano',
  'diary.correct': 'Corrigir…',
  'diary.correct.why': 'Uma entrada não é editada; uma correção é escrita ao lado dela.',
  'diary.photo.open': 'Abrir {name}',
  'diary.photo.alt': 'Foto {name}, {day}',
  'diary.photo.noThumb': 'Sem prévia — o arquivo está guardado.',
  'diary.chain.note':
    'Cada entrada leva o hash da anterior, então uma alteração feita no arquivo fora do Ridgebeam aparece. Isso é evidência de adulteração — não uma assinatura, e não prova jurídica.',
  'diagnostics.diary.title': 'O diário',
  'diagnostics.diary.verify': 'Verificar o diário',
  'diagnostics.diary.intact.one': '{count} entrada, cadeia intacta',
  'diagnostics.diary.intact.other': '{count} entradas, cadeia intacta',
  'diagnostics.diary.empty': 'Nenhuma entrada ainda — a cadeia está intacta',
  'diagnostics.diary.broken': 'Quebrada na nº {seq}: {reason}',
  'diagnostics.diary.problem.contents':
    'a entrada não confere mais com o seu hash — ela foi alterada fora do Ridgebeam',
  'diagnostics.diary.problem.link': 'a entrada não aponta para a anterior',
  'diagnostics.diary.problem.missing': 'falta uma entrada',
  'diagnostics.diary.notYet': 'Ainda não verificado nesta janela.',
  'diary.figure.finished': 'Feito',
  ...
  'dashboard.noEntry.hint': 'Dias úteis desde o começo da obra sem nada escrito.',
  ...
  'state.started': 'começada em {day}',
  'state.notStarted': 'não começada',
  'schedule.bar.finished': '{sentence}, terminada em {day}',
  'schedule.bar.started': '{sentence}, começada em {day}',
  'schedule.legend.done':
    'Terminada: a barra cheia; começada: uma marca a partir do dia em que começou',
