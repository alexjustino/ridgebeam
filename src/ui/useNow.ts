 ...
 *
 * The clock is the one thing that changes without anybody touching it, and
 * this is the one place that admits it. Everything downstream takes `now` as an
 * argument and stays pure, which is why it is testable and this hook is not.
 *
 ...
 *
 * Pass `null` to stop ticking. A screen that shows no clock should not
